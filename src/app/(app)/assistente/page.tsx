        ...
        <div className="space-y-6">
          ...
          <Card className="bg-card/30 backdrop-blur-xl border-primary/10 shadow-xl rounded-3xl overflow-hidden">
            ...
            <CardContent className="space-y-4">
              <Input placeholder="Cole um link relevante..." className="bg-background/50 border-primary/10 rounded-xl" />
              <Textarea placeholder="Cole anotações ou textos rápidos aqui..." className="min-h-[100px] bg-background/50 border-primary/10 rounded-xl" />
              <Button variant="secondary" className="w-full rounded-xl font-bold">Enviar Texto</Button>
            </CardContent>
          </Card>
        </div>
